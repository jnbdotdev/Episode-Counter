	...
	public Manual() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Para ser redirecionado � tela principal do programa \n voc� deve apertar em 'Avan�ar' no menu principal");
		...
		btnNewButton_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Para voltar � tela anterior voc� deve pressionar o bot�o 'Voltar'");
